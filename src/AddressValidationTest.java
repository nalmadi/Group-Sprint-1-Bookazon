public class AddressValidationTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AddressValidator.validateAddress(address1.getStreetAddress(), address1.getCity(), address1.getState(), address1.getZipCode());
        ...
        try {
            ...
            AddressValidator.validateAddress(address2.getStreetAddress(), address2.getCity(), address2.getState(), address2.getZipCode());
        ...
        try {
            ...
            AddressValidator.validateAddress(address3.getStreetAddress(), address3.getCity(), address3.getState(), address3.getZipCode());
        ...
        try {
            ...
            AddressValidator.validateAddress(address4.getStreetAddress(), address4.getCity(), address4.getState(), address4.getZipCode());
        ...
        try {
            ...
            AddressValidator.validateAddress(address5.getStreetAddress(), address5.getCity(), address5.getState(), address5.getZipCode());
